...
def RF_train(sample_path, SavePath, space, msg, val_size=0.5):
    msg.emit("*" * 30 + " 开始训练 " + "*" * 30)
    ...
    # 分割训练集和验证集
    train_data, val_data, train_label, val_label = Split_train_val_dataset(
    ...
    # 超参数优化
    max_f1_dict = HyperOptimize(train_data, train_label, val_data, val_label, max_evals=20)
...
if __name__ == "__main__":
    ...
    msg = ""
    # 训练
    RF_train(sample_path, SavePath, space, msg, val_size=0.4)
    # msg_emitter = MsgEmitter()
    # RF_train(sample_path, SavePath, space, msg_emitter, val_size=0.4)